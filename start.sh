...
download_php() { # Скачивание PHP-FPM
    ...
    cd php-$1
    echo -en "\nㅤㅤㅤㅤ\033[1;33mWebMultiEgg: \033[22;37mПодготовка компилятора...\nㅤ"
    ./configure --prefix=/home/container/php --enable-mbstring --with-curl --with-openssl --with-mysql --with-pdo-mysql --with-zlib --with-fpm-user=www-data --with-fpm-group=www-data --enable-fpm --with-config-file-path=/home/container/etc/php-fpm/ --with-config-file-scan-dir=/home/container/etc/php-fpm/php-fpm.d/
...
if [ ! -f "/home/container/.eggSystem/Config" ]; then # В случае отсутствия этого файла система попросит установить интересующий веб-сервер
    ...
    echo -en "\n\033[1;33mㅤㅤㅤㅤПожалуйста, выберите интересующий Вас тип сервера для установки:\nㅤ"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ1) Скачивание и компиляция чистого веб-сервера OpenResty;"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ2) Скачивание и компиляция OpenResty вместе с PHP Fast Process Manager (PHP-FPM);"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ3) Скачивание и компиляция чистого веб-сервера Nginx;"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ4) Скачивание и компиляция Nginx вместе с PHP Fast Process Manager (PHP-FPM);"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ5) Скачивание и компиляция чистого PHP Fast Process Manager (PHP-FPM);"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ6) Выйти."
    echo -en "\nㅤ\nㅤ\nㅤㅤㅤㅤㅤㅤㅤㅤВнимание! PHP (Hypertext PreProcessor) - это скриптовый язык общего назначения, интенсивно применяемый для\nㅤㅤㅤㅤㅤㅤㅤㅤразработки веб-приложений, но НИ В КОЕМ СЛУЧАЕ НЕ ЯВЛЯЕТСЯ ВЕБ-СЕРВЕРОМ!"
    echo -en "\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤ\nㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ\033[36mPowered by _DarkNessYT in 2024y."
    echo -en "\nㅤ"
    read -s servertype
    case $servertype in
    ...
    if [ "$SERVER_TYPE" = "openresty without php-fpm" ]; then
        ...
        echo -en "\033[1;33mWebMultiEgg: \033[22;37mNginx был успешно запущен. Все логи находятся в папке /nginx/logs.\n\033[1;33mWebMultiEgg: \033[1;31mВНИМАНИЕ! \033[22;37mНе удаляйте папку .eggSystem, поскольку эта папка хранит данные о вашем сервере и она является ядром для этого сервера.\n\033[1;33mWebMultiEgg: \033[22;37m Файлы конфигурации для Nginx находятся в папке /nginx/conf.\nㅤ"
        ./nginx/sbin/nginx -p '/home/container/nginx/' -g 'daemon off;'
    elif [ "$SERVER_TYPE" = "nginx with php-fpm" ]; then
        echo -en "\033[1;33mWebMultiEgg: \033[22;37mNginx и PHP-FPM были успешно запущены. Все логи Nginx находятся в папке /nginx/logs.\n\033[1;33mWebMultiEgg: \033[1;31mВНИМАНИЕ! \033[22;37mНе удаляйте папку .eggSystem, поскольку эта папка хранит данные о вашем сервере и она является ядром для этого сервера.\n\033[1;33mWebMultiEgg: \033[22;37m Файлы конфигурации для Nginx находятся в папке /nginx/conf.\nㅤ"
