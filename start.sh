...
if [ ! -f "/home/container/.eggSystem/Config" ]; then # В случае отсутствия этого файла система попросит установить интересующий веб-сервер
    ...
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ1) Установка и настройка чистого веб-сервера OpenResty;"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ2) Установка и настройка OpenResty вместе с PHP Fast Process Manager (PHP-FPM);"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ3) Установка и настройка чистого веб-сервера Nginx;"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ4) Установка и настройка Nginx вместе с PHP Fast Process Manager (PHP-FPM);"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ5) Установка и настройка чистого PHP Fast Process Manager (PHP-FPM);"
    echo -en "\nㅤㅤㅤㅤㅤㅤㅤㅤ6) Выйти."
